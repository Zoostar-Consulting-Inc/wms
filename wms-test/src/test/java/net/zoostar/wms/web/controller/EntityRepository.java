...
@Slf4j
@Getter
public class EntityRepository<T extends AbstractStringPersistable> implements InitializingBean {
	
	protected final Map<Class<T>, Map<String, T>> repositories = new HashMap<>();
	
	protected final ObjectMapper mapper = new ObjectMapper();

	@Setter
	private Set<Class<T>> entityTypes;
